...
"Umbramancia": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"><path d="M 13.5 28.5 L 26.5 29 L 39.5 35 Z" fill="#2f3048" opacity="0.8"/><polygon points="15.5,17 24.5,16.5 26.5,29 13.5,28.5" fill="#5a5c86" stroke="#28293c" stroke-width="0.8"/></svg>',
...
"Gravitomancia": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"><g stroke="#387a60" stroke-width="2" fill="none" stroke-linecap="round"><path d="M 9 7 C 12 14 17 18 20 20.5"/><path d="M 20 6 C 20 12 20 17 20 20.5"/><path d="M 31 7 C 28 14 23 18 20 20.5"/></g><circle cx="20" cy="27" r="7.5" fill="#387a60"/><circle cx="17" cy="24" r="2.2" fill="#50ad88" opacity="0.6"/></svg>',
...
"Magia Ancestral": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"><path d="M 15.8 15.8 A 6 6 0 0 1 24.2 15.8" fill="none" stroke="#a3852f" stroke-width="2.4"/><path d="M 12.1 13.8 A 10 10 0 0 1 27.9 13.8" fill="none" stroke="#a3852f" stroke-width="2.4"/><path d="M 8.1 12.6 A 14 14 0 0 1 33.8 17.6" fill="none" stroke="#a3852f" stroke-width="2.4"/><path d="M 33.9 21.9 A 14 14 0 0 1 8.1 27.4" fill="none" stroke="#a3852f" stroke-width="2.4"/></svg>',
...
"Magia Aberrante": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"><path d="M 20 5 L 24 11 L 22 16 L 26.5 21 L 23 26.5 L 25 31 L 20 36 L 15 31 L 17 26.5 L 13.5 21 L 18 16 L 16 11 Z" fill="#0c0f0a"/><path d="M 18.5 11.1 L 19.8 13.5 L 18.5 15.9 L 17.2 13.5 Z" fill="#c8d4a0"/><path d="M 21.5 21.2 L 23.0 24 L 21.5 26.8 L 20.0 24 Z" fill="#c8d4a0"/><path d="M 17.8 28 L 18.9 30 L 17.8 32 L 16.7 30 Z" fill="#c8d4a0"/><path d="M 20 5 L 24 11 L 22 16 L 26.5 21 L 23 26.5 L 25 31 L 20 36 L 15 31 L 17 26.5 L 13.5 21 L 18 16 L 16 11 Z" fill="none" stroke="#7a8550" stroke-width="2.2" stroke-linejoin="round"/></svg>',
