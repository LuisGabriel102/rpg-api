...
"Hemomancia": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"><path d="M 20 3.5 C 22.8 8 23.6 11 23 13.3 C 22.4 15.6 17.6 15.6 17 13.3 C 16.4 11 17.2 8 20 3.5 Z" fill="#984e46"/><path d="M 20 18 C 21.3 19.8 21.3 21 20 21.6 C 18.7 21 18.7 19.8 20 18 Z" fill="#984e46"/><circle cx="20" cy="24.5" r="1.15" fill="#984e46"/><polygon points="8,32.3 11.5,30.4 14.5,31.4 18.5,29.6 20,30.1 24,31.1 28,30.4 32,32.4 29,34.2 22.5,35 20,34.8 13,34.5" fill="#984e46"/></svg>',
"Biomancia": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"><path d="M 20 7.5 C 27 7.5 28 14 25.5 18 C 24.5 19.5 24.5 20.5 25.5 22 C 28 26 27 32.5 20 32.5 C 13 32.5 12 26 14.5 22 C 15.5 20.5 15.5 19.5 14.5 18 C 12 14 13 7.5 20 7.5 Z" fill="#c2837b" fill-opacity="0.15" stroke="#c2837b" stroke-width="1.8"/><circle cx="18" cy="13" r="2.2" fill="#c2837b"/><circle cx="22.5" cy="15" r="1.5" fill="#c2837b"/><circle cx="19" cy="27" r="2.6" fill="#c2837b"/><circle cx="16.5" cy="24" r="1.3" fill="#c2837b"/></svg>',
...
"Zoomancia": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"><ellipse cx="20" cy="28" rx="7.8" ry="6.2" fill="#a85c54"/><ellipse cx="12" cy="16.5" rx="1.9" ry="2.7" fill="#a85c54" transform="rotate(28 12 16.5)"/><ellipse cx="17" cy="12" rx="2.0" ry="2.9" fill="#a85c54" transform="rotate(8 17 12)"/><ellipse cx="23" cy="12" rx="2.0" ry="2.9" fill="#a85c54" transform="rotate(-8 23 12)"/><ellipse cx="28" cy="16.5" rx="1.9" ry="2.7" fill="#a85c54" transform="rotate(-28 28 16.5)"/></svg>',
"Metamorfomancia": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"><path d="M 20 6 L 11 12 L 14 20 L 9 27 L 20 34 Z" fill="#a05a52"/><path d="M 20 6 C 28 8 31 16 26 21 C 31 25 28 31 20 34 Z" fill="#a05a52" fill-opacity="0.5"/><line x1="20" y1="6" x2="20" y2="34" stroke="#a05a52" stroke-width="1.3"/></svg>',
...
"Encantomancia": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"><path d="M 34.0 20.0 L 33.59 22.64 L 32.69 25.13 L 31.35 27.37 L 29.62 29.29 L 27.58 30.83 L 25.31 31.94 L 22.9 32.58 L 20.45 32.75 L 18.03 32.44 L 15.74 31.69 L 13.67 30.53 L 11.88 29.02 L 10.43 27.21 L 9.37 25.18 L 8.73 23.02 L 8.52 20.8 L 8.73 18.62 L 9.35 16.54 L 10.34 14.65 L 11.66 13.0 L 13.25 11.66 L 15.03 10.66 L 16.95 10.03 L 18.93 9.79 L 20.88 9.93 L 22.74 10.43 L 24.45 11.27 L 25.94 12.4 L 27.16 13.77 L 28.08 15.33 L 28.68 17.01 L 28.93 18.74 L 28.85 20.46 L 28.45 22.11 L 27.75 23.62 L 26.8 24.94 L 25.62 26.03 L 24.29 26.86 L 22.84 27.41 L 21.35 27.66 L 19.87 27.62 L 18.45 27.3 L 17.14 26.73 L 16.0 25.93 L 15.05 24.95 L 14.33 23.83 L 13.84 22.61 L 13.61 21.36 L 13.62 20.11 L 13.87 18.92 L 14.34 17.83 L 14.99 16.87 L 15.79 16.07 L 16.71 15.47 L 17.7 15.07 L 18.72 14.87 L 19.73 14.87 L 20.69 15.07 L 21.57 15.44 L 22.33 15.96 L 22.96 16.6 L 23.43 17.32 L 23.74 18.09 L 23.89 18.89 L 23.87 19.66 L 23.71 20.39 L 23.42 21.05 L 23.02 21.61 L 22.54 22.06 L 22.0 22.38 L 21.43 22.58 L 20.87 22.66 L 20.32 22.62 L 19.83 22.48 L 19.4 22.25 L 19.05 21.96 L 18.78 21.62 L 18.61 21.25 L 18.53 20.88 L 18.54 20.53 L 18.62 20.22 L 18.76 19.96 L 18.94 19.76 L 19.15 19.62 L 19.36 19.55 L 19.57 19.55 L 19.75 19.61 L 19.88 19.71 L 19.97 19.85 L 20.0 20.0" fill="none" stroke="#3a8c94" stroke-width="2.0" stroke-linecap="round" stroke-linejoin="round"/></svg>',
...
"Magia Aberrante": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"><path d="M 18 5 L 23 13 L 15.5 19 L 24 26 L 18.5 33 L 21 37" fill="none" stroke="#7a8550" stroke-width="2.7" stroke-linejoin="miter" stroke-linecap="round"/><path d="M 23 13 L 29.5 10.5 M 15.5 19 L 8.5 22 M 15.5 19 L 13 14 M 24 26 L 30 29.5" fill="none" stroke="#7a8550" stroke-width="1.5" stroke-linejoin="miter" stroke-linecap="round"/><polygon points="26.5,16.2 27.8,17.5 26.5,18.8 25.2,17.5" fill="#c8d4a0"/><polygon points="11.5,24.9 12.6,26 11.5,27.1 10.4,26" fill="#c8d4a0"/><polygon points="20.5,8.1 21.4,9 20.5,9.9 19.6,9" fill="#c8d4a0"/></svg>',
