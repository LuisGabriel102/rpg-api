...
# ============================================================
# A CATEDRAL DO ALDERYN (v6.3) — landing in-place de /oficina
# Bloco A: funcao pura (template + render), sem I/O.
# Layout 100% INLINE (classe so para fonte): o NiceGUI/Quasar ignora layout em
# CLASSE mas respeita estilo INLINE. Cada card tem height:182px e background:arco
# inline. Sem !important, sem dependencia de classe de layout.
...
<div aria-label="A Catedral do Alderyn" style="max-width:680px;margin:0 auto;background:#13172a;border:1px solid rgba(202,162,58,.34);border-radius:12px;padding:1.4rem 1.3rem 1.5rem">
