...
"Hemomancia": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"><polygon points="19,11 22,16 27,15 24,20 28,24 22,24.5 20,30.5 17,25 11.5,27 15,21 10,18 16,16" fill="#984e46"/><circle cx="30" cy="12" r="2.0" fill="#984e46"/><circle cx="31" cy="26" r="1.4" fill="#984e46"/><circle cx="9" cy="30" r="1.6" fill="#984e46"/><circle cx="26.5" cy="32" r="1.1" fill="#984e46"/><circle cx="8" cy="13" r="1.2" fill="#984e46"/></svg>',
